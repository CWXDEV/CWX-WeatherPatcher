...
{
    //class SnowEnablerPatch7 : Patch  // MAKES CHANGES TO WEATHERDEBUG - COPYPARAMS - 2ND
    //{

    //    public SnowEnablerPatch7() : base(T: typeof(SnowEnablerPatch7), postfix: nameof(PostFixPatch))
    //    {
    //    }

    //    protected override MethodBase GetTargetMethod()
    //    {
    //        return typeof(WeatherDebug).GetMethod("CopyParams", BindingFlags.Public | BindingFlags.Instance, null, new Type[] { typeof(WeatherDebug)}, null);
    //    }
